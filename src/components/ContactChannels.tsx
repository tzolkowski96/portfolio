        ...
        {socials.map((s) => (
          <li key={s.label}>
            <a
              ...
              className="flex min-h-tap items-center justify-between gap-2 bg-panel px-4 font-mono text-nav uppercase text-ink transition-colors hover:bg-ink hover:text-cream2"
            >
              {s.label}
              <ExternalLinkIcon />
            </a>
